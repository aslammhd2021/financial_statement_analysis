...
The goal of this project is to transform raw financial data into meaningful business insights using SQL and Power BI.

This project focuses on:

* Understanding financial statements
* Performing data transformation using SQL
